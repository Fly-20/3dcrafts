...
const localBusinessSchema = {
  ...
  url: siteConfig.url,
  logo: `${siteConfig.url}/3dcrafts-logo.svg`,
  ...
  hasOfferCatalog: {
    ...
    itemListElement: ["3D printing", "Rapid prototyping", "Laser cutting", "Laser engraving"].map((name) => ({
      "@type": "Offer",
      itemOffered: { "@type": "Service", name },
    })),
  },
  ...(siteConfig.googleBusinessProfileUrl ? { sameAs: [siteConfig.googleBusinessProfileUrl] } : {}),
};
    ...
    <>
      ...
      <main id="main-content">
        <section className="hero" id="top" aria-labelledby="hero-title">
          ...
          <div className="hero-bottom reveal reveal-delay-2"><p>Custom 3D printing, laser cutting and engraving from our Edinburgh workshop for people with a sketch, a problem, or a brilliant idea.</p><a href="#quote" className="text-link">Start your project <Arrow /></a></div>
        ...
        <section className="intro section-pad" aria-labelledby="intro-title">
          <p className="eyebrow">What we do in Edinburgh</p><div className="intro-grid"><h2 id="intro-title">We turn good ideas into <em>objects that work.</em></h2><div className="intro-copy"><p>3DCRAFTS is an independent Edinburgh workshop making one-offs, prototypes and short production runs for designers, businesses and curious individuals across Scotland and the UK.</p><p>We pair digital precision with a maker&apos;s eye — helping you choose the right process, material and finish from the start.</p><a href="#services" className="text-link dark-link">Explore our capabilities <Arrow /></a></div></div>
        </section>
